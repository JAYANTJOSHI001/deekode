  ...
  const faqs = [
    {
      ...
      questions: [
        {
          question: 'What services does AccountFirm offer?',
          answer: "AccountFirm offers a wide range of accounting services including tax preparation, bookkeeping, financial planning, auditing, and business consulting for both individuals and businesses."
        },
        {

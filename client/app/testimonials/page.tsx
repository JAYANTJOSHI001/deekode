  ...
  const testimonials = [
    {
      ...
      quote: 'Deekode has been instrumental in helping our startup navigate complex financial challenges. Their expertise and personalized service are unmatched.',
      rating: 5,
    ...
    },
    {
      ...
      quote: "We've been working with Deekode for over five years now, and they've consistently provided top-notch accounting services. Highly recommended!",
      rating: 5,
      image: '/placeholder.svg?height=100&width=100',
    },
    {
      ...
      quote: "Deekode's international tax expertise has been crucial for our expanding business. They've saved us both time and money.",
      rating: 4,
      image: '/placeholder.svg?height=100&width=100',
    },
  ]
  ...
  const caseStudies = [
    {
      ...
      description: 'How Deekode helped a tech startup optimize their finances and secure Series A funding.',
    ...
    },
    {
      ...
      description: "Deekode's role in supporting the rapid expansion of a renewable energy company.",

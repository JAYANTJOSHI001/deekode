...
const TestimonialSlider = () => {
  const testimonials = [
    { id: 1, text: "Deekode has been instrumental in helping our business grow. Their expertise and dedication are unmatched.", author: "John Doe, CEO of TechCorp" },
    { id: 2, text: "I've been working with Deekode for years, and they consistently deliver excellent results. Highly recommended!", author: "Jane Smith, Founder of StartupX" },
    { id: 3, text: "The team at Deekode goes above and beyond. They're not just accountants; they're true partners in our success.", author: "Mike Johnson, CFO of GrowthCo" },
  ];

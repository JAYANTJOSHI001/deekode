...
const PreviousClientsPage = () => {
    const [clients, setClients] = useState([
        { id: 1, name: 'David Wilson', email: 'david@example.com', phone: 9858752838 , date: '2022-12-01', message: 'i want to have consultation' },
        { id: 2, name: 'Emma Taylor', email: 'emma@example.com', phone: 9858752838,  date: '2022-12-01', message: 'i surely want to have your services' },
        { id: 3, name: 'Frank Miller', email: 'frank@example.com', phone: 98587528388,  date: '2022-12-01', message: 'i am glad to subscribe you' },
    ]);
        ...
        if (shiftedClientString) {
          ...
          setClients(prevClients => [
            ...prevClients,
            {
              ...
              message: 0, // You might want to calculate this based on their history
            },
          ]);
        }
      }, []);
                ...
                <div className="container mx-auto px-6">
                    <div className="mb-8 relative">
                        <input
                            ...
                            className="w-full p-4 pr-12 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-500"
                            value={searchTerm}
                        ...
                        <table className="w-full">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer" onClick={() => handleSort('message')}>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filteredClients.map((client) => (
                                    <tr key={client.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">{client.date}</td>
                                        <td className="px-6 py-4 whitespace-nowrap">{client.message.toLocaleString()}</td>
